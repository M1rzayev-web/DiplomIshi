...
//         let baza = data;
      ...
      <h4>${item.price - 20} $</h4>
              ...
              <h4 id="carPrice">${item.price} $</h4>
              </div>
              <span><i class="fa-solid fa-times"></i></span>
              <div class="product-quantity">
              <div class="product-quantity-inner">
              <span onclick="decPrice()"><i class="fa-solid fa-minus"></i></span>
              <input type="text" id="valueCar" value="1">
              <span onclick="incPrice()"><i class="fa-solid fa-plus"></i></span>
              </div>
              </div>
            ...
            const valueCar = document.getElementById("valueCar");
            const priceCar = document.getElementById("priceCar");

            carPrice.innerHTML = item.price;
            priceCar.innerHTML = item.price * valueCar.value + "$"

            function incPrice() {
                const itemPrice = ++valueCar.value;
                carPrice.innerHTML = item.price;
                priceCar.innerHTML = item.price * itemPrice + "$"
                const inputValue = parseInt(valueCar.value, 10);
                ...
                if (inputValue >= 14 && inputValue < 30) {
                  priceCar.innerHTML = (item.price - 30) * inputValue + "$"
                  carPrice.innerHTML = item.price - 30;
                } else if (inputValue >= 30) {
                  priceCar.innerHTML = (item.price - 50) * inputValue + "$"
                  carPrice.innerHTML = item.price - 50;
                }
            }
            ...
            function decPrice() {
              ...
              valueCar.addEventListener("change", function () {
                const inputValue = parseInt(valueCar.value, 10);
